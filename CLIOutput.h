...
typedef struct CLILineInfo CLILineInfo;

extern void					CLIGetSigHandleList(MICommand *cmd, MIList **signals);
extern double				CLIGetGDBVersion(MICommand *cmd);
extern char *				CLIGetGDBArch(MICommand *cmd);
extern char *				CLIGetPtypeInfo(MICommand *cmd);
extern MIList *				CLIGetPtypeFieldList(MICommand *cmd);
extern char *				CLIGetWhatisInfo(MICommand *cmd);
...
extern CLILineInfo *		CLILineInfoNew(void);
extern void					CLILineInfoFree(CLILineInfo *);
extern MIList *				CLIGetListInfo(MICommand *);
extern MIList *				CLIGetVariablesFromInfoScopeInfo(MICommand *);
