...
extern MIVar *			MIVarParse(MIList *results);
...
extern char *			MIGetVarInfoPathExpression(MICommand *cmd);
extern char *			MIGetDataEvaluateExpressionInfo(MICommand *cmd);
extern void			MIGetVarUpdateInfo(MICommand *cmd, MIList **varchanges);
